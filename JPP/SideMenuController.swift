...
//        self.matchupdateController = UINavigationController(rootViewController: matchupdateController)
    ...
    var data = ["HOME", "SCHEDULE", "MERCHANDISE", "GALLERY", "JPP TV", "NEWS & MEDIA","KNOW YOUR PANTHERS","WALLPAPERS", "POINTS TABLE", "FAN CORNER", "ABOUT", "SPONSORS"]
    var dataimage = ["home.png", "season4.png", "Tshirt-Icon.png", "gallery.png", "jpptv.png", "newsicon.png","know.png","galleryinside.png","point.png", "fan.png","about.png", "sponsorsimg.png"]
