...
//        if(json["latestMatch"]["team1"].string == "U Mumba" && json["latestMatch"]["team2"].string == "Jaipur Pink Panthers"){
//            updates1.team1image.image = UIImage(named:"umumba")
//            updates1.team2image.image = UIImage(named:"t5")
//        }else if(json["latestMatch"]["team2"].string == "U Mumba" && json["latestMatch"]["team1"].string == "Jaipur Pink Panthers"){
//            updates1.team1image.image = UIImage(named:"t5")
//            updates1.team2image.image = UIImage(named:"umumba")
//        }else{
...
//
//                            if(json["latestMatch"]["team1"].string == "U Mumba" && json["latestMatch"]["team2"].string == "Jaipur Pink Panthers"){
//                                updates.team1Image.image = UIImage(named:"umumba")
//                                updates.team2Image.image = UIImage(named:"t5")
//                            }else if(json["latestMatch"]["team2"].string == "U Mumba" && json["latestMatch"]["team1"].string == "Jaipur Pink Panthers"){
//                                updates.team1Image.image = UIImage(named:"t5")
//                                updates.team2Image.image = UIImage(named:"umumba")
//                            }else if(json["latestMatch"]["team2"].string == "U Mumba"){
//                                updates.team1Image.hnk_setImageFromURL(rest.getImageSizeCache(json["latestMatch"]["appteamimage1"].stringValue))
//                                updates.team2Image.image = UIImage(named:"umumba")
//                            }else if(json["latestMatch"]["team1"].string == "U Mumba"){
//                                updates.team2Image.hnk_setImageFromURL(rest.getImageSizeCache(json["latestMatch"]["appteamimage1"].stringValue))
//                                updates.team1Image.image = UIImage(named:"umumba")
//                            }else if(json["latestMatch"]["team2"].string == "Jaipur Pink Panthers"){
//                                updates.team1Image.hnk_setImageFromURL(rest.getImageSizeCache(json["latestMatch"]["appteamimage1"].stringValue))
//                                updates.team2Image.image = UIImage(named:"t5")
//                            }else if(json["latestMatch"]["team1"].string == "Jaipur Pink Panthers"){
//                                updates.team2Image.hnk_setImageFromURL(rest.getImageSizeCache(json["latestMatch"]["appteamimage1"].stringValue))
//                                updates.team1Image.image = UIImage(named:"t5")
//                            }else{
//                                updates.team1Image.hnk_setImageFromURL(rest.getImageSizeCache(json["latestMatch"]["appteamimage1"].stringValue))
